		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#autoinvoicedashboard-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"autoinvoicedashboard-display": {
								"semanticObject": "autoinvoicedashboard",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=autoinvoicedashboard",
									"url": sap.ui.require.toUrl("autoinvoicedashboard")
								}
							}
						}
					}
